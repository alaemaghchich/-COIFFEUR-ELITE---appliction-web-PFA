    ...
    <div class="d-flex">
        ...
        <div class="sidebar admin-sidebar p-4">
            ...
            <ul class="nav flex-column gap-3">
                ...
                <li class="nav-item">
                    <a href="support.php" class="nav-link"><i class="fas fa-headset me-2"></i> Support</a>
                </li>
                <li class="nav-item">
                    <a href="blacklist.php" class="nav-link"><i class="fas fa-user-slash me-2"></i> Blacklist</a>
                </li>
                <li class="nav-item mt-4">
                    <a href="/index.php" class="nav-link text-gold"><i class="fas fa-home me-2"></i> Main Site</a>
                </li>
